...
<div style="width: 100%; line-height: 800px; vertical-align: bottom">
    ...
    <div class="topnav">
        ...
        <a href="withdrawal.jsp" target="payOperationalFrame">Вывод</a>
        <a href="replenish.jsp" target="payOperationalFrame">Пополнение</a>
    </div>
    <iframe frameborder="0" name="payOperationalFrame" width="100%" height="200px"/>
</div>
</div>
</body>
</html>
